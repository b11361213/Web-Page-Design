...
Move-Item "C:\Users\$username\Downloads\xampp\" "C:\xampp\"
Remove-Item -Recurse "C:\xampp\htdocs\*"
xcopy "C:\Users\$username\Downloads\Web-Page-Design-main\htdocs\*" "C:\xampp\htdocs\" /e

# 安裝 certificate
New-Item -Path "C:\xampp\apache\" -Name "crt" -ItemType "Directory"
xcopy "C:\Users\$username\Downloads\Web-Page-Design-main\others\cert.conf" "C:\xampp\apache\crt\"
xcopy "C:\Users\$username\Downloads\Web-Page-Design-main\others\make-cert.bat" "C:\xampp\apache\crt\"
...
xcopy "C:\Users\$username\Downloads\Web-Page-Design-main\others\httpd-xampp.conf" "C:\xampp\apache\conf\extra\"
